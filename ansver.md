...
Из за **«поверхностного копирования»** могут происходить ошибки, использовать его можно только если у нас нет динамических полей в структуре 
...
Рассказать про оба и таблица сравнения VLA vs alloca.
...
|sizeof|?(подумайте сами)|?(подумайте сами)|
